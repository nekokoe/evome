...
public class BalloonTips extends PopupPanel {
	...
	public interface Resources extends ClientBundle {
		@Source("org/evome/evoKalc/client/ui/resources/BalloonTipsAlert15.png")
		ImageResource tip();

		@Source("org/evome/evoKalc/client/ui/resources/BalloonTipsCss.css")
		CssResource css();
	}
	...
	protected void onLoad() {
        ...
        public void showOnTopOf(Widget w){
            int zindex;
            if (w.getElement().getStyle().getZIndex().isEmpty()){
                zindex = 0;
            }else{
                zindex = Integer.parseInt(w.getElement().getStyle().getZIndex());
            }
